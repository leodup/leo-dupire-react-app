        ...
        <div>
            ...
            <div className="PortfolioBody">
                ...
                <div className="MechE">
                    ...
                    <p id="Section">I built a car when I was twelve years old! For my birthday, I asked my parents, not for a present, but for a project. They couldn’t say no to such a request.<br></br><br></br>
                    ...
                    <h3 id="Section">Hydrodynamic Water Tunnel</h3>
                    <p id="Section">In 11th grade, I decided to conduct a research project with two classmates for our TPE (Travaux Personnels Encadrés) in the French Baccalaureate. In simplified terms, the requirements for this assignment were to complete a year-long project on essentially anything we wanted.<br></br><br></br>
