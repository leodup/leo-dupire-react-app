...
import "../Portfolio/PortfolioFiles/GoKart.css";
import "../Portfolio/PortfolioFiles/Hydro.css";
import "../Portfolio/PortfolioFiles/Hyperloop.css";
import "../Portfolio/PortfolioFiles/Music.css";
import "../Portfolio/PortfolioFiles/Alphabite.css";
...
const Portfolio2 = () => {
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            const letters = document.querySelectorAll('.Head#Portfolio h1 .letter');
            if (letters.length > 0) {
                // Mixed up letter speeds for more interesting movement
                letters[0].style.transform = `translateY(-${scrollPosition * 0.3}px)`; // P
                ...
                letters[3].style.transform = `translateY(-${scrollPosition * 0.7}px)`; // T
                letters[4].style.transform = `translateY(-${scrollPosition * 0.1}px)`; // F - slowest
                letters[5].style.transform = `translateY(-${scrollPosition * 0.6}px)`; // O
                letters[6].style.transform = `translateY(-${scrollPosition * 0.4}px)`; // L
                letters[7].style.transform = `translateY(-${scrollPosition * 0.5}px)`; // I
                letters[8].style.transform = `translateY(-${scrollPosition * 0.9}px)`; // O - very fast
            }
        };
        ...
        <div>
            <div className="Sidebar" id="disp" style={{ opacity: isHidden ? 0 : 1, transition: 'opacity 0.25s' }}>
                <div className="SidebarBlock" id="disp">
                    <a style={{textDecoration: 'none'}} href="#DataScience">
                        <p className='SidebarTitle' id="disp">Machine Learning & AI</p>
                    </a>
                    <div style={{ display: SecDS ? 'none' : 'block' }}>
                        <a style={{textDecoration: 'none'}} href="#PDF">
                            <p className='SidebarText' id="disp">GREmLN</p>
                        </a>
                        <a style={{textDecoration: 'none'}} href="#WNet">
                            <p className='SidebarText' id="disp">Collision Prediction</p>
                        </a>
                        <a style={{textDecoration: 'none'}} href="#HummingFace">
                            <p className='SidebarText' id="disp">Music Generation</p>
                        </a>
                        <a style={{textDecoration: 'none'}} href="#NLP">
                            <p className='SidebarText' id="disp">NLP</p>
                        </a>
                    </div>

                    <a style={{textDecoration: 'none'}} href="#ComputerScience">
                    ...
                    <div style={{ display: SecCS ? 'none' : 'block' }}>
                        ...
                        <a style={{textDecoration: 'none'}} href="#Ventilator">
                            <p className='SidebarText' id="disp">Respiratory Ventilator</p>
                        </a>
                        <a style={{textDecoration: 'none'}} href="#DAC">
                            <p className='SidebarText' id="disp">Museum of Science</p>
                        </a>
                    </div>

                    <a style={{textDecoration: 'none'}} href="#MechE">
                        <p className='SidebarTitle' id="disp">Mechanical Engineering</p>
                    </a>
                    <div style={{ display: SecME ? 'none' : 'block' }}>
                        <a style={{textDecoration: 'none'}} href="#Hyperloop">
                            <p className='SidebarText' id="disp">Hyperloop</p>
                        </a>
                        <a style={{textDecoration: 'none'}} href="#GoKart">
                            <p className='SidebarText' id="disp">Go Kart</p>
                        </a>
                        <a style={{textDecoration: 'none'}} href="#HydroTunnel">
                            <p className='SidebarText' id="disp">Hydrodynamics</p>
                        </a>
                    </div>

                    <a style={{textDecoration: 'none'}} href="#Random">
                    ...
                    <div style={{ display: SecR ? 'none' : 'block' }}>
                        ...
                        <a style={{textDecoration: 'none'}} href="#TED">
                            <p className='SidebarText' id="disp">TEDx Talk</p>
                        </a>
                        <a style={{textDecoration: 'none'}} href="#Alphabite">
                            <p className='SidebarText' id="disp">Alphabite</p>
                        </a>
                        <a style={{textDecoration: 'none'}} href="#Hobbies">
            ...
            <div className="PortfolioBody">
                <div className="DataScience" ref={SidebarSecDS}>
                    ...
                    <div className='Project'>
                        ...
                        <p className="Section">My teammate Mateus Aragão and I started designing and building multiple deep learning generative models (GAN, Auto-Encoder, Diffusion), for a Deep Learning class, to generate sample sounds from a user prompt. I later extended this to a solo project. Such models can be used to aid musicians in finding that 'elusive' sound that they may not know how to obtain through traditional means. The model generates original sounds for users to sample, even introducing a new source of inspiration for composition.</p>
                    </div>
                    <div className='Project'>
                ...
                <div className="Random" ref={SidebarSecR}>
                    ...
                    <div className='Project'>
                        ...
                        <p className="Section">I compose and perform music. My production software of choice is Logic Pro X. I play the guitar, piano, some drums, and sing. I don't like labels, though my music currently fits into the indie/alternative rock genre. I like to exhibit versatility in whatever I do. Styles span from traditional alternative rock, to pieces with heavy classical and operatic undertones, to reggae-like passages, to more modern tastes. Not all at the same time... for the most part. You can learn more at <a href="/music" target="_blank" rel="noopener noreferrer">leodupire.com/music</a>.</p>
                    </div>
                    <div className='Project'>
